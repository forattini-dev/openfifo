...
When onboarding finishes, we auto-open the dashboard and print a clean link. If it prompts for auth, enter the password from `gateway.auth.password` (or `OPENCLAW_GATEWAY_PASSWORD`). To reopen later: `openclaw dashboard`.
